...
public class CreditVerificationFacade
        implements CreditVerification {

    /**
     * Use of "amount" here is a violation of encapsulation. Should use a command object to encapsulate all
     * the data.
     *
     * @param custProfile
